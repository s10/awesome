...
awful.rules.rules = {
    ...
    { rule = { class = "Gajim.py"       }, properties = { tag = tags[1][4], floating = false } },
    { rule = { class = "Wine"           }, properties = { tag = tags[1][3], floating = true } }, -- TeamViewer
    { rule = { class = "Eiskaltdcpp-qt" }, properties = { tag = tags[1][2] } },
    { rule = { class = "Deluge-gtk"     }, properties = { tag = tags[1][1] } }
}
-- }}}
-- {{{ Signals
